...
void MPU6050_Data_Prepare(float T)
{
	...
	mpu6050.Gyro_deg.x = ((float)mpu6050.Gyro.x / GyroAxis_Sensitive);
	mpu6050.Gyro_deg.y = ((float)mpu6050.Gyro.y / GyroAxis_Sensitive);
	mpu6050.Gyro_deg.z = ((float)mpu6050.Gyro.z / GyroAxis_Sensitive);

	mpu6050.Acc_deg.x = ((float)mpu6050.Acc.x / AccAxis_Sensitive);
	mpu6050.Acc_deg.y = ((float)mpu6050.Acc.y / AccAxis_Sensitive);
	mpu6050.Acc_deg.z = ((float)mpu6050.Acc.z / AccAxis_Sensitive);
    //======================================================================
}
