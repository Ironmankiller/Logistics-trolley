...
#define DEBUG(string)       u2_printf(string);
#elif DEBUG_PORT_SELECT == 3
#define DEBUG(string)       u3_printf(string);
#elif DEBUG_PORT_SELECT == 4
#define DEBUG(string)       u4_printf(string);
#elif DEBUG_PORT_SELECT == 5
#define DEBUG(string)       u5_printf(string);
#endif												    
